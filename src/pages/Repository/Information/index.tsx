import { CheckCircleIcon, Cog8ToothIcon, ExclamationCircleIcon } from "@heroicons/react/24/outline";
        ...
        <div className="w-full flex flex-row bg-slate-50 shadow-md" style={{ height: "14%" }}>
            <div className="w-full h-full flex justify-start items-center px-6">
                ...
                <button className="w-10 h-10 flex justify-center bg-slate-50 rounded-full items-center ml-3 mt-1 transition ease-linear hover:text-slate-500">
                    {hasError ? <CheckCircleIcon className="h-7 text-sky-500 hover:text-sky-700" /> : <ExclamationCircleIcon className="h-7 text-red-500 hover:text-red-700" />}
                </button>
                <button className="w-10 h-10 flex justify-center bg-slate-50 rounded-full items-center ml-1 mt-1 transition ease-linear hover:text-slate-500">
