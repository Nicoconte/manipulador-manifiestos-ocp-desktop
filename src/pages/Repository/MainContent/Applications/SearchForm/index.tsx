        ...
        <div className="w-full h-full flex justify-start items-center">
            <div className="relative w-full">
                ...
                <input
                    ref={inputRef}
                    type={"text"}
                    className="block w-full h-10 p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-3xl bg-gray-50 outline-none focus:outline-none appearance-none shadow-md placeholder:text-slate-400"
